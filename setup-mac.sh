...
#
# ╔═══════════════════════════════════════════════════════════════════════════╗
# ║                    SETUP MACBOOK AIR M4 - SCRIPT                          ║
# ║                                                                           ║
# ║  Installa Homebrew, Oh-My-Zsh, Powerlevel10k e tutti i programmi          ║
# ║  configurando l'accesso per due utenti.                                   ║
# ╚═══════════════════════════════════════════════════════════════════════════╝
#
# Uso: ./setup-mac.sh [--dry-run]
#
...
FORMULAS_CLI_ESSENTIALS=(
    fzf  bat eza #ripgrep the_silver_searcher
    htop tree watch #jq jsonlint
...
CASKS_DEV=(
    visual-studio-code iterm2 docker-desktop
    github tableplus claude claude-code mistral-vibe codex #gitkraken
)

CASKS_PRODUCTIVITY=(
    obsidian anki #notion slack
)
...
echo -e "${BOLD}${PURPLE}"
cat << "EOF"
   _____ ______ _______ _    _ _____    __  __          _____
  / ____|  ____|__   __| |  | |  __ \  |  \/  |   /\   / ____|
 | (___ | |__     | |  | |  | | |__) | | \  / |  /  \ | |
  \___ \|  __|    | |  | |  | |  ___/  | |\/| | / /\ \| |
  ____) | |____   | |  | |__| | |      | |  | |/ ____ \ |____
 |_____/|______|  |_|   \____/|_|      |_|  |_/_/    \_\_____|

EOF
echo -e "${NC}"
echo -e "${CYAN}Script di configurazione per MacBook Air M4${NC}"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
